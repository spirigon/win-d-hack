"""Quick test: v17 with K=75 and K=80 to see if new features help when included."""
...
def main():
    ...
    for K in [70, 75, 80, 85]:
        ...
        # Train 3 specialists (5 seeds each) and average.
        regime_preds = []
        ...
        nmae = normalized_mae(y_va_mw, avg3_mw)
        print(f"  K={K:3d}: Fold-5 = {nmae:.4f}%")
