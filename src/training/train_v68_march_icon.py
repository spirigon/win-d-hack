...
Outputs:
    data/processed/v68_oof.parquet
    data/processed/v68_test.parquet
    submissions/archive/v68.0_march_icon.csv

Usage:
    python -m src.training.train_v68_march_icon --seeds 3
    python -m src.training.train_v68_march_icon --seeds 5
"""
...
OOF_PATH    = _ROOT / "data" / "processed" / "v68_oof.parquet"
TEST_PATH   = _ROOT / "data" / "processed" / "v68_test.parquet"
OUTPUT_PATH = _ROOT / "submissions" / "archive" / "v68.0_march_icon.csv"
...
def main() -> None:
    ...
    print("=" * 72)
    print(f"V68: V64 (March 3x only) + ICON-EU NWP features  ({len(seeds)} seeds)")
