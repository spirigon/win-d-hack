...
Outputs:
    data/processed/v68b_oof.parquet
    data/processed/v68b_test.parquet
    submissions/archive/v68b.0_march_icon_5s.csv

Usage:
    python -m src.training.train_v68b_march_icon_5s --seeds 3
    python -m src.training.train_v68b_march_icon_5s --seeds 5
"""
...
OOF_PATH    = _ROOT / "data" / "processed" / "v68b_oof.parquet"
TEST_PATH   = _ROOT / "data" / "processed" / "v68b_test.parquet"
OUTPUT_PATH = _ROOT / "submissions" / "archive" / "v68b.0_march_icon_5s.csv"
...
def main() -> None:
    ...
    print("=" * 72)
    print(f"V68b: V68 with 5 seeds  ({len(seeds)} seeds)")
