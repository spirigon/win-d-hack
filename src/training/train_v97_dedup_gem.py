"""V97: V94 + duplicate-column removal + GEM/ICON-Global inter-model features.
...
Outputs:
    data/processed/v97_oof.parquet
    submissions/archive/v97.0_dedup_gem.csv
"""
...
OOF_PATH    = _ROOT / "data" / "processed" / "v97_oof.parquet"
OUTPUT_PATH = _ROOT / "submissions" / "archive" / "v97.0_dedup_gem.csv"
...
def main() -> None:
    ...
    print("=" * 72)
    print(f"V97: dedup + GEM/ICON-G features  ({len(SEEDS)} seeds, K={K})")
    print("=" * 72)
