"""V90: V75 + all new features, K=90, 5 seeds, CF/MW blend.

Hypothesis: smear and seasonal features ranked 81-95 in the K=80 probe.
Raising K to 90 lets borderline-useful features compete.
...
Key changes vs V87:
  - K: 80 → 90  (10 extra features allowed)
  - Seeds: 3 → 5  (matches v75, eliminates 0.04pp seed-count penalty)

Outputs:
    data/processed/v90_oof.parquet
    submissions/archive/v90.0_k90.csv
"""
...
OOF_PATH    = _ROOT / "data" / "processed" / "v90_oof.parquet"
OUTPUT_PATH = _ROOT / "submissions" / "archive" / "v90.0_k90.csv"
...
def main() -> None:
    ...
    print("=" * 72)
    print(f"V90: V75 + all new features, K={K}, {len(SEEDS)} seeds, CF/MW blend")
    ...
    print(f"  Features at ranks 81-{K}: {new_slots}")
